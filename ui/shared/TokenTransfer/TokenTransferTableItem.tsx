...
const TokenTransferTableItem = ({
  ...
  return (
    <Tr alignItems="top">
      ...
      <Td>
      { total && 'token_id' in total && (
  <TokenTransferNft hash={token.address} id={total.token_id} isLoading={isLoading} />
)}
      </Td>
      { showTxInfo && txHash && (
        <Td>
      ...
      <Td isNumeric verticalAlign="top">
        ...
        {total && 'value' in total && BigNumber(total.value).div(BigNumber(10 ** Number(total.decimals))).dp(8).toFormat()}
        </Skeleton>
      </Td>
    </Tr>
  );
