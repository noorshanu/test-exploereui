...
const TokenTransferListItem = ({
  ...
  const value = (() => {
    if (total === null || total === undefined || !('value' in total)) {
      return null;
    }
  ...
  return (
    <ListItemMobile rowGap={ 3 } isAnimated>
      ...
      { value && (token.type === 'DRC-20' || token.type === 'ERC-1155') && (
      ...
      { total !== null && total !== undefined && 'token_id' in total && (token.type === 'ERC-721' || token.type === 'ERC-1155') && (
